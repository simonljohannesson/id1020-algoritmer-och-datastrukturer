...
//    }
    ...
    public DijkstraSearchBF(EdgeWeightedDigraph g, int source){
    ...
    public static void main(String[] args){
        try {
            ...
            DijkstraSearchBF searchBF = new DijkstraSearchBF(digraph, s);

            System.out.println(searchBF.hasPathTo(t));
            System.out.println("Path from " + s + " to " + t);
            Iterable<DirectedEdge> iter;
            if((iter = searchBF.pathTo(t)) != null){
                for(DirectedEdge e : searchBF.pathTo(t)){
                    System.out.print(e + " ");
                }
                System.out.println();
            }else{
